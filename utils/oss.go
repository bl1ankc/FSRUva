...
func GetPicUrl(filename string) (string, bool) {
	...
	// 填写存储空间名称，例如examplebucket。
	bucket, err := client.Bucket(Const.BucketName)
	if err != nil {
...
func GetSTSToken() (sts.Credentials, bool) {
	...
	client, err := sts.NewClientWithAccessKey(Const.RegionID, Const.AccessKeyID, Const.AccessKeySecret)
	if err != nil {
